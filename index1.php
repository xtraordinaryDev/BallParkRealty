...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JCDXGF1C3T"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-QYC349YK70');
</script>
...
============================================= -->
    <div class="dtr-responsive-header header-with-slick-menu fixed-top">
        <div class="container">
            ...
            <!-- small devices logo -->
            <div class="dtr-responsive-header-left"> <a class="dtr-logo" href="https://ballparkrealtymn.com/"><img src="https://ballparkrealtymn.com/bizops/assets/images/logo.png" alt="logo" width="170px"></a></a> </div>
    ...
    <header id="dtr-header-global" class="fixed-top">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="dtr-header-left">
                ...
                <!-- logo -->
                <a class="logo-default dtr-scroll-link" href="https://ballparkrealtymn.com/"><img src="https://ballparkrealtymn.com/bizops/assets/images/logo.png" alt="logo" width="200px"></a>

                <!-- logo on scroll -->
                <a class="logo-alt dtr-scroll-link" href="https://ballparkrealtymn.com/"><img src="https://ballparkrealtymn.com/bizops/assets/images/logo.png" alt="logo" width="200px"></a>
                <!-- logo on scroll ends -->
          ...
          <!-- menu starts-->
            <div class="main-navigation">
                <ul class="sf-menu dtr-nav dark-nav-on-load dark-nav-on-scroll">
                    ...
                    <li><a class="nav-link" href="https://ballparkrealtymn.idxbroker.com/idx/roster">Meet Our Agents</a></li>

                    <li class=""><a class="nav-link" href="https://ballparkrealtymn.idxbroker.com/idx/search/advanced">Searches</a> 
                    ...
                    <li><a class="nav-link" href="https://ballparkrealtymn.com/#contact">Contact</a></li>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-12 col-md-6 small-device-space">
                            <div class="dtr-small-box dtr-rounded blank-space-left bg-red">
                                ...
                                <!-- form starts -->
                                <div class="dtr-form">
                                <form action="https://forms.zohopublic.com/blake23/form/BallparkRealty/formperma/H21qQ737xfCNpZgiQOG-uvEhNvyDQ9XPpK3ohHmhyQM/htmlRecords/submit" name='form' id='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data'>
        ...
        <div class="dtr-form-row dtr-form-row-2col clearfix">
            <div class="dtr-form-column">
                <p class="dtr-form-field">
                    <input name="Name_First" fieldType=7  type="text" placeholder="First Name" required>
                </p>
            </div>
            <div class="dtr-form-column">
                <p class="dtr-form-field">
                    <input name="Name_Last"  fieldType=7 type="text" placeholder="Last Name" required>
                </p>
            </div>
        </div>
        <!-- form two columns ends -->
        <p class="dtr-form-field">
            <input name="Emailmail" fieldType=9 class="required email" type="text" placeholder="Email Address" required>
        </p>
        <p class="dtr-form-field">
            <input name="PhoneNumber_countrycode" type="text" fieldType=11 placeholder="Phone Number" required>
        </p>
        <p class="dtr-form-field">
            <input name="SingleLine"  fieldType=1 type="number" placeholder="Zip Code" required>
        </p>
            ...
            <div class="container">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <!-- text-->
                                        <img src="https://ballparkrealtymn.com/img/award.png" align="right">
    ...
    <footer id="dtr-footer">
        <div class="container">
            ...
            <div class="row">
                ...
                <!--== column 1 starts ==-->
                <div class="col-12 col-md-4">
                    <p>&copy; 2022 Ballpark Realty  - <a href="https://ballparkrealtymn.com/lakeville/agents/">Lakeville</a> | 
                        <a href="https://ballparkrealtymn.com/rosemount/agents/">Rosemount</a> |
                        <a href="https://ballparkrealtymn.com/burnsville/agents/">Burnsville</a></p>
