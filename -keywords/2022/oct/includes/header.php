...
<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW"> 
	...
	<title>Keywords <?php echo $title;?></title>
	...
	color: #222222;
		...
		#documenter_sidebar ol a{-webkit-text-shadow:0px 0px 0px #EEEEEE;-moz-text-shadow:0px 0px 0px #EEEEEE;text-shadow:0px 0px 0px #EEEEEE;}
